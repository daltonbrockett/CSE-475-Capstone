...
options = vision.GestureRecognizerOptions(
    ...
    running_mode=vision.RunningMode.IMAGE,  # Use IMAGE mode for sync processing
    num_hands=1,
...
try:
    while True:
        ...
        image = picam2.capture_array()  # RGB888
        ...
        # Synchronously run gesture recognition on the current frame
        ...
        if result and result.hand_landmarks:
            for hand_index, hand_landmarks in enumerate(result.hand_landmarks):
                ...
                # Create and draw landmarks protobuf message
